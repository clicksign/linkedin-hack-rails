...
class GooglesControllerTest < ActionController::TestCase
  ...
  test "should create google" do
    assert_difference('Google.count') do
      post :create, google: { couch_id: @google.couch_id, description: @google.description, link: @google.link, query: @google.query, title: @google.title }
    end
  ...
  test "should update google" do
    patch :update, id: @google, google: { couch_id: @google.couch_id, description: @google.description, link: @google.link, query: @google.query, title: @google.title }
    assert_redirected_to google_path(assigns(:google))
  end
